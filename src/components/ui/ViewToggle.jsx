    ...
    <div className={styles.wrap}>
      {showAgenda && (
        <button
          ...
          title={t('ui.viewToggle.agenda', 'Visão Agenda')}
        >
      ...
      <button
        ...
        title={t('ui.viewToggle.kanban', 'Visão Kanban')}
      >
        <svg viewBox="0 0 16 16" fill="currentColor">
      ...
      <button
        ...
        title={t('ui.viewToggle.list', 'Visão Lista')}
      >
        <svg viewBox="0 0 16 16" fill="currentColor">
      ...
      {showCalendar && (
        <button
          ...
          title={t('ui.viewToggle.calendar', 'Visão Calendário')}
        >
          <svg viewBox="0 0 16 16" fill="currentColor">
